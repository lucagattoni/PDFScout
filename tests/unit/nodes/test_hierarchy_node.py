...
class TestGeometricPreSorter:
    ...
    def test_sorts_by_page_number(self):
        b1 = {"block_id": "b1", "type": "paragraph", "text": "x", "bbox": {"page_number": 2, "coordinates": [0, 0, 10, 10]}}
        b2 = {"block_id": "b2", "type": "paragraph", "text": "x", "bbox": {"page_number": 1, "coordinates": [0, 0, 10, 10]}}
    ...
    def test_sorts_by_ymin_within_column(self):
        b1 = {"block_id": "b1", "type": "paragraph", "text": "x", "bbox": {"page_number": 1, "coordinates": [200, 10, 250, 50]}}
        b2 = {"block_id": "b2", "type": "paragraph", "text": "x", "bbox": {"page_number": 1, "coordinates": [50, 10, 100, 50]}}
        result = geometric_pre_sorter([b1, b2])
        assert result[0]["block_id"] == "b2"
        assert result[1]["block_id"] == "b1"
    ...
    def test_sorts_by_column_bucket(self):
        ...
        b1 = {"block_id": "b1", "type": "paragraph", "text": "x", "bbox": {"page_number": 1, "coordinates": [0, 100, 10, 150]}}
        b2 = {"block_id": "b2", "type": "paragraph", "text": "x", "bbox": {"page_number": 1, "coordinates": [0, 10, 10, 60]}}
        result = geometric_pre_sorter([b1, b2])
        assert result[0]["block_id"] == "b2"
        assert result[1]["block_id"] == "b1"
...
class TestLayoutHierarchyAgentNode:
    ...
    async def test_single_block_skips_api_and_sets_parent_none(self, sample_state, sample_block, mocker):
        mock_class = mocker.patch("src.nodes.hierarchy_node.AsyncAnthropic")
        mock_client = mock_class.return_value
    ...
    async def test_multiple_blocks_with_api_response(self, sample_state, sample_block, mocker):
        block2 = {**sample_block, "block_id": "blk-002", "bbox": {**sample_block["bbox"], "coordinates": [200, 50, 300, 80]}}
        relations = [
    ...
    async def test_missing_from_relation_map_gets_orphan_warning(self, sample_state, sample_block, mocker):
        block2 = {**sample_block, "block_id": "blk-002", "bbox": {**sample_block["bbox"], "coordinates": [200, 50, 300, 80]}}
